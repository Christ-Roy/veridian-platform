...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_pages_blocks_hero_ctas_variant" AS ENUM('primary', 'secondary');
  CREATE TYPE "public"."enum_pages_blocks_services_items_icon" AS ENUM('check', 'hammer', 'home', 'wrench', 'star', 'shield', 'leaf', 'clock');
  CREATE TYPE "public"."enum_pages_blocks_richtext_alignment" AS ENUM('left', 'center');
  CREATE TYPE "public"."enum_pages_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__pages_v_blocks_hero_ctas_variant" AS ENUM('primary', 'secondary');
  CREATE TYPE "public"."enum__pages_v_blocks_services_items_icon" AS ENUM('check', 'hammer', 'home', 'wrench', 'star', 'shield', 'leaf', 'clock');
  CREATE TYPE "public"."enum__pages_v_blocks_richtext_alignment" AS ENUM('left', 'center');
  ...
  CREATE TABLE "pages_blocks_services_items" (
  	...
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"icon" "enum_pages_blocks_services_items_icon" DEFAULT 'check',
  	"title" varchar,
  	"description" varchar
  );
  ...
  CREATE TABLE "pages_blocks_richtext" (
  	...
  	"title" varchar,
  	"body" jsonb,
  	"alignment" "enum_pages_blocks_richtext_alignment" DEFAULT 'left',
  	"block_name" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_services_items" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"icon" "enum__pages_v_blocks_services_items_icon" DEFAULT 'check',
  	"title" varchar,
  	"description" varchar,
  	"_uuid" varchar
  );
  ...
  CREATE TABLE "_pages_v_blocks_richtext" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"_path" text NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  	"body" jsonb,
  	"alignment" "enum__pages_v_blocks_richtext_alignment" DEFAULT 'left',
  	"_uuid" varchar,
  	"block_name" varchar
  );
  ...
  ALTER TABLE "_pages_v_blocks_richtext" ADD CONSTRAINT "_pages_v_blocks_richtext_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_pages_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "_pages_v_blocks_richtext_order_idx" ON "_pages_v_blocks_richtext" USING btree ("_order");
  CREATE INDEX "_pages_v_blocks_richtext_parent_id_idx" ON "_pages_v_blocks_richtext" USING btree ("_parent_id");
  CREATE INDEX "_pages_v_blocks_richtext_path_idx" ON "_pages_v_blocks_richtext" USING btree ("_path");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "_pages_v_blocks_richtext" CASCADE;
  ...
  DROP TYPE "public"."enum_pages_blocks_services_items_icon";
  DROP TYPE "public"."enum_pages_blocks_richtext_alignment";
  DROP TYPE "public"."enum_pages_status";
  DROP TYPE "public"."enum__pages_v_blocks_hero_ctas_variant";
  DROP TYPE "public"."enum__pages_v_blocks_services_items_icon";
  DROP TYPE "public"."enum__pages_v_blocks_richtext_alignment";
